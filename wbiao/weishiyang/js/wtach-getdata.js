...
function getdata() {
            ...
            function bb() {
                for (var i = 12; i < 24; i++) {
                    newl.children[0].innerHTML += `
                                <dl>
                                    <dt>
                                        <a onclick="detail(${mess[i].id})" target="_blank" onclick="detail(${mess[i].id})">
                                    ...
                                    <dd>
                                        <h6>
                                            <a >${mess[i].tit}</a>
                                            <a onclick="detail(${mess[i].id})" target="_blank">${mess[i].title}</a>
                                        </h6>
                                        <p class="p1">
                                            <span>作者：万表世界</span>
                                        ...
                                        <p class="p2">
                                            <a onclick="detail(${mess[i].id})" target="_blank">
    ...
    xhr.open("GET", "http://localhost:8081/wbiao/weishiyang/php/getdata.php", true);
    xhr.send();
};
function detail(id) {
    window.open("http://localhost:8081/wbiao/weishiyang/details.html?id=" + id);
}
function getwx() {
