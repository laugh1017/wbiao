...
function aa(a, b) {
    ...
    xhr.open("GET", "http://localhost:8081/wbiao/weishiyang/php/choose-watch.php", true);
    xhr.send();
};
aa(0, 5);

function deta(id){
    window.open("http://localhost:8081/wbiao/weishiyang/Brands_commodity.html?id="+id);
};
