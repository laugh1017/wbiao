...
function ask(type="商务") {
    ...
    xhr.open('GET', 'http://localhost:8081/wbiao/php/wbiao_select.php?type='+type+'&parger=1', true);
    xhr.send();
}

function num(id){
    window.open("http://localhost:8081/wbiao/wbiao-shop.html?id="+id)
}
