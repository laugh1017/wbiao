...
var iconadd = document.getElementById("icon_address");
iconadd.onclick = function () {
    if (a == 0) {
        a = 1;
        iconadd.className = "icon_address";
    } else {
        a = 0;
        iconadd.className = "";
    }
...
addbir.onchange=function(){
    birthday=this.value
};
saveinfor.onclick=function(){
    if(sex1.checked){
        prname.innerHTML=addname.value;
        prname.innerHTML=addrname.value;psex.innerHTML=sex2.nextElementSibling.innerHTML;
        // pbir.innerHTML=birthday;
        infor.style.display="none";
        addbg.style.display="none";
    }else{
        prname.innerHTML=addname.value;
        prname.innerHTML=addrname.value;psex.innerHTML=sex1.nextElementSibling.innerHTML;
        // pbir.innerHTML=birthday;
        infor.style.display="none";
        addbg.style.display="none";
    }
